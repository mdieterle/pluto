...
PPDGPlugin::PPDGPlugin(const Char_t *id, const Char_t *de):
    ...
    is_initialized = is_extend_resonances = kFALSE;
}
...
Bool_t PPDGPlugin::ExecCommand(const char * command, Double_t value) {
	...
	if (is_extend_resonances) return kTRUE;
	...
	//============================= N(1520)0 ==================================
//	makeStaticData()->AddParticle(92,"ND130", 1.52);   //PID, name, mass
//	makeStaticData()->AddAlias("ND130","Delta(1520)0");
//	makeStaticData()->SetParticleTotalWidth("ND130",0.115);
//	makeStaticData()->SetParticleBaryon("ND130",1);
//	makeStaticData()->SetParticleSpin("ND130",3);
//	makeStaticData()->SetParticleCharge("ND130",0);
//	makeStaticData()->SetParticleIsospin("ND130",1);
//	makeStaticData()->SetParticleParity("ND130",-1);
//	//-------------------- N,pi ---------------
//	makeStaticData()->AddDecay("ND130 --> p + pi-", "ND130",
//	    		       "p,pi-", 0.6/3. );		//PDG - {0.55-0.65}
//	makeStaticData()->AddDecay("ND130 --> n + pi0", "ND130",
//	    		       "n,pi0", 0.6*2./3. );
//
//	//============================= N(1520)+ ==================================
//	makeStaticData()->AddParticle(93,"ND13+", 1.52);   //PID, name, mass
//	makeStaticData()->AddAlias("ND13+","Delta(1520)+");
//	makeStaticData()->SetParticleTotalWidth("ND13+",0.115);
//	makeStaticData()->SetParticleBaryon("ND13+",1);
//	makeStaticData()->SetParticleSpin("ND13+",3);
//	makeStaticData()->SetParticleCharge("ND13+",1);
//	makeStaticData()->SetParticleIsospin("ND13+",1);
//	makeStaticData()->SetParticleParity("ND13+",-1);
//	//-------------------- N,pi ---------------
//	makeStaticData()->AddDecay("ND13+ --> p + pi0", "ND13+",
//	    		       "p,pi0", 0.6/3. );		//PDG - {0.55-0.65}
//	makeStaticData()->AddDecay("ND13+ --> n + pi+", "ND13+",
//	    		       "n,pi+", 0.6*2./3. );
//
	//============================= D(1700)- ==================================
	...
	makeStaticData()->AddDecay("DD330 --> n + g", "DD330",
	    		       "n,g", 0.002 );
	//-------------------D1232,eta
	makeStaticData()->AddDecay("DD330 --> Delta0 + eta", "DD330",
				       "D0,eta", 0.05 );
	...
	makeStaticData()->AddDecay("DD33+ --> p + g", "DD33+",
	    		       "p,g", 0.002 );
	//-------------------D1232,eta
	makeStaticData()->AddDecay("DD33+ --> Delta+ + eta", "DD33+",
	    		       "D+,eta", 0.05 );
	...
	//============================= D(1920)0 ==================================
	makeStaticData()->AddParticle(90,"DDD330", 1.92);   //PID, name, mass
	makeStaticData()->AddAlias("DDD330","Delta(1920)0");
	makeStaticData()->SetParticleTotalWidth("DDD330",0.26);
	makeStaticData()->SetParticleBaryon("DDD330",1);
	makeStaticData()->SetParticleSpin("DDD330",3);
	makeStaticData()->SetParticleCharge("DDD330",0);
	makeStaticData()->SetParticleIsospin("DDD330",3);
	makeStaticData()->SetParticleParity("DDD330",1);
	//-------------------D1232,eta
	makeStaticData()->AddDecay("DDD330 --> Delta0 + eta", "DDD330",
				       "D0,eta", 0.15 );

	//============================= D(1920)+ ==================================
	makeStaticData()->AddParticle(91,"DDD33+", 1.92);   //PID, name, mass
	makeStaticData()->AddAlias("DDD33+","Delta(1920)+");
	makeStaticData()->SetParticleTotalWidth("DDD33+",0.26);
	makeStaticData()->SetParticleBaryon("DDD33+",1);
	makeStaticData()->SetParticleSpin("DDD33+",3);
	makeStaticData()->SetParticleCharge("DDD33+",1);
	makeStaticData()->SetParticleIsospin("DDD33+",3);
	makeStaticData()->SetParticleParity("DDD33+",1);
	//-------------------D1232,eta
	makeStaticData()->AddDecay("DDD33+ --> Delta+ + eta", "DDD33+",
	    		       "D+,eta", 0.15 );

        is_extend_resonances = kTRUE;

	return kTRUE;
    }
    else if (strcmp (command,"init") == 0) {
	if (is_initialized) return kTRUE;
